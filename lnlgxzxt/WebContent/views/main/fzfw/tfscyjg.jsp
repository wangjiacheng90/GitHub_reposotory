 ...
 <!-- 工具栏 -->
     <div class="border clearfix">
			...
			<div class="tools1">
				...
				<ul class="seachform">
					<li><label class="l_f">起始日期：</label><input
						class="inline laydate-icon" id="querydate1" value=""></li>
				</ul>
				<ul class="seachform">
					<li><label class="l_f">终止日期：</label><input
						class="inline laydate-icon" id="querydate2" value=""></li>
				</ul>
				<ul class="toolbar">
			...
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					...
					<li class="active"><a data-toggle="tab" href="#1"><i
							class="green fa fa-home bigger-110"></i>&nbsp;火电厂月合计</a></li>

					<li class=""><a data-toggle="tab" data-toggle="dropdown"
						class="dropdown-toggle" href="#2">风电场月合计</a></li>
					<li class=""><a data-toggle="tab" data-toggle="dropdown"
						class="dropdown-toggle" href="#3">核电厂月合计</a></li>
  ...
  <script type="text/javascript" src="js/mytool/laydate_data.js"></script> 
	<script type="text/javascript" src="js/main/fzfw/tfscyjg.js"></script>
