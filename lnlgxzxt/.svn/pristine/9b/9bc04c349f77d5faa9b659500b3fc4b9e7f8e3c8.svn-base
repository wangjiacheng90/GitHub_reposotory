  ...
  <!--右侧样式-->
   ...
   <!-- 工具栏 -->
     ...
     <span class="Statistic_title Statistic_btn"><a title="隐藏" class="top_close_btn">隐藏</a></span>
      ...
      <!-- 曲线 -->
      <div id="Statistics" class="Statistics" style="overflow:scroll;" >
      <div id="main" style="height:380px;  min-width:18000px; overflow:auto"  ></div> 
    </div>
      ...
      <div class="grading_list">
       <div class="type_title">曲线数据列表</div>
         <div class="table_menu_list">
              ...
              <table class="table table-striped table-bordered table-hover" id="dataList_table"  style="overflow:scroll;">
             </table>
        </div>  <!-- ./table_menu_list -->
...
/**************/
	...
	<script type="text/javascript" src="js/main/fzfw/AGCkhjs.js"></script> 
