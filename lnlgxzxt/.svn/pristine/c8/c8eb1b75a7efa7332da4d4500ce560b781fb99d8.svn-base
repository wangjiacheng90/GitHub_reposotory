...
(function ($) {
  $.fn.tableExport = function (options) {
   ...
   // 2018-06-21 这增加了 格式样式==============
      docFile +="<style type='text/css'>";
      docFile +="table,th,td";
      docFile +="{";
      docFile +="border:1px solid blue;";
      docFile +="}";
      docFile +="</style>";
// 2018-06-21 这以上增加了 格式样式=========================
      ...
      // 2018-06-21 这增加了 标题  ===============================
      docFile +="<h4 align='left'>表六：</h1>";
      docFile +="<h1 align='center'>并网运行考核和辅助服务补偿结算汇总表</h1>";
      
      docFile +="<div class='text' style=' text-align:center;'>2018年一季度</div>";
      docFile +="<div class='text' style=' text-align:right;'>单位：万千瓦、万千瓦时、万元、元/兆瓦时、%</div>";
