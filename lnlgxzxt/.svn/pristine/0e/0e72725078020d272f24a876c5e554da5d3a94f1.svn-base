...
<div class="page-content clearfix">
 ...
 <div class="state-overview clearfix">
          ...
          <div class="title_name">统计信息</div>
           ...
           <tbody>
           <tr><td class="name">未处理信息：</td><td class="munber"><a href="#">0</a>&nbsp;个</td></tr>
           <tr><td class="name">待处理信息：</td><td class="munber"><a href="#">10</a>&nbsp;个</td></tr>
           <tr><td class="name">待考核数据：</td><td class="munber"><a href="#">13</a>&nbsp;个</td></tr>
           <tr><td class="name">已确认数：</td><td class="munber"><a href="#">26</a>&nbsp;个</td></tr>
           <tr><td class="name">处理失败：</td><td class="munber"><a href="#">26</a>&nbsp;个</td></tr>
           </tbody>
          </table>
         </div> 
         <div class="Order_Statistics">
          <div class="title_name">正常运行信息</div>
           <table class="table table-bordered">
           <tbody>
           <tr><td class="name">运行台数：</td><td class="munber"><a href="#">140</a>&nbsp;个</td></tr>
           <tr><td class="name">检修：</td><td class="munber"><a href="#">10</a>&nbsp;个</td></tr>
           <tr><td class="name">临检：</td><td class="munber"><a href="#">13</a>&nbsp;个</td></tr>
           <tr><td class="name">跳闸：</td><td class="munber"><a href="#">26</a>&nbsp;个</td></tr>
           <tr><td class="name">非停：</td><td class="munber"><a href="#">21</a>&nbsp;条</td></tr>

           </tbody>
          </table>
         </div> 
        <!--  <div class="Order_Statistics">
          <div class="title_name">今日统计信息</div>
           <table class="table table-bordered">
           <tbody>
         ...
         <div class="news_style">
          ...
          <ul class="list">
           ...
           <li><i class="icon-bell red"></i><a href="#">6月共处理订3451次</a></li>
           <li><i class="icon-bell red"></i><a href="#">后台系统并网运行是开通了。</a></li>
           <li><i class="icon-bell red"></i><a href="#">后台系统辅助服务开通了。</a></li>
           <li><i class="icon-bell red"></i><a href="#">后台系统结算开通了。</a></li>
          </ul>
         </div> 
         </div>
 <!--记录-->
