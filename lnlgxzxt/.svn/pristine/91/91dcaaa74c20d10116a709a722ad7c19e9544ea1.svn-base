...
<script src="assets/bootstrap/bootstrap-table-master/dist/extensions/editable/bootstrap-table-editable.js"></script>
 ...
 <!-- 表头和格式 -->
 <script type="text/javascript" src="js/main/jdbb/bb4_export_config.js"></script> 
...
<!-- 数据表格 -->
  <div class="sort_list">
    <table class="table table-striped table-bordered table-hover" id="dataList_table"   style="table-layout: fixed; width:60px; word-break:break-all; word-wrap:break-all;">
  ...
  <script type="text/javascript" src="js/mytool/laydate_data.js"></script> 
	<script type="text/javascript" src="js/main/jdbb/bb4.js"></script>
