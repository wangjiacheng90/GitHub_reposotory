...
<head>
		...
		<link rel="stylesheet" href="../../assets/css/bootstrap-tab.css"/>
		<!--[if lte IE 8]>
	...
	<body>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">  <!-- 导航上面的链接-->
					<!-- <a href="https://" class="navbar-brand"> -->
						<a href="#" class="navbar-brand"  style="color:#FFF;font-size:42px;">
								<small>
									<img src="../../images/gd_logo.jpg" style="width:70px; height:70px;  line-height: 70px;">
									
									<font  size="6" letter-spacing:55px; >  &nbsp &nbsp辽宁电网两个细则技术支持系统  &nbsp &nbsp</font>

									<img src="../../images/gd_logo_bg.jpg" style="width:333px; height:75px; float:right; line-height: 70px;">
								</small>
							</a><!-- 
               ...
               <ul class="nav ace-nav">	
				...
				<%String name = (String)session.getAttribute("uname"); %>
	            	<%-- <span>用户名：<%=name %>&nbsp;&nbsp;&nbsp;&nbsp;</span> --%>
				 <span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>用户:<%=name %></span>
				 <i class="icon-caret-down"></i>
				</a>
				<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">

				 <li><a href="javascript:void(0)" name="admin_info.html" title="个人信息" class="change_Password"><i class="icon-user"></i>个人资料</a></li>
				 <li class="divider"></li>
	   ...
	   <!-- start -->
		  ...
		  <div class="main-content">
				...
				<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="homePage.jsp">  </iframe>
	...
	<!-- end menu- replace -->			
        ...
        <!--  <div class="footer_style" id="footerstyle">  
		 <script type="text/javascript">try{ace.settings.check('footerstyle' , 'fixed')}catch(e){}</script>
          <p class="l_f">版权所有：北京科东有限公司专业开发</p>
          <p class="r_f">qq：290416775</p>
         </div> -->
