...
//        				
        			...
        			[
            			...
            			{
            				field : 'field6',
            				title : '&nbsp&nbsp择优&nbsp',
            				valign:"middle",
            	            align:"center",
             	            width:100
            			},{
            				field : 'field7',
            				title : '&nbsp&nbsp竞价&nbsp',
            				valign:"middle",
            	            align:"center",
             	            width:100
            			},
...
//输出Excel方法
        function exportExcel(){
        	$('#dataList_table').tableExport({ type: 'excel', fileName: '电力辅助服务基础数据表',worksheetName: 'sheet1', tableName: '信息', excelstyles: ['background-color', 'color', 'font-size', 'font-weight'],  escape: 'false' })
        }
