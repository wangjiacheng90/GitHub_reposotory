...
<div class="page-content clearfix">
 ...
 <!-- 工具栏 -->
			...
			<div class="tabbable">
				<ul class="nav nav-tabs" id="myTab">
					...
					<li class="active"><a data-toggle="tab" href="#1"><i
							class="green fa fa-home bigger-110"></i>&nbsp;火电厂日合计</a></li>

					<li class=""><a data-toggle="tab" data-toggle="dropdown"
						class="dropdown-toggle" href="#2">风电场日合计</a></li>
					<li class=""><a data-toggle="tab" data-toggle="dropdown"
						class="dropdown-toggle" href="#3">核电厂日合计</a></li>
  ...
  <script type="text/javascript" src="js/mytool/laydate_data.js"></script> 
	<script type="text/javascript" src="js/main/fzfw/tfscrjg.js"></script>
