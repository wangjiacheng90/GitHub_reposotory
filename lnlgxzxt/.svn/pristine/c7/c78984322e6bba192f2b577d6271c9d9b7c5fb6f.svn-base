...
dragapproved=true
document.getElementById("dwindow_title").onmousemove=drag_drop
}
 
function loadwindow(width,height,data1,data2,title_Data){
...
document.getElementById("dwindow").style.top="100px";   //2018-07-08调整上下位置
//document.getElementById("cframe").src=url
}

// 给弹出div_title赋值
document.getElementById('title_font').innerText=title_Data;
dwindow_content_datadiv(data1,data2);
