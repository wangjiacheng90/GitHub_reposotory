...
//	var new_data =getYYYYMM(rq);  
	var docFile_title =" <div class='text' style='text-align:left;'><font size='3'  face='宋体' color='black'>表五：</font></div> ";   

//	 docFile_title +="<h3 align='center'>2018年一季度</h3>";
	 docFile_title +=" <div class='text' style='text-align:center;'><b><font size='5'  face='宋体' color='black'>电力辅助服务费用总表</font></b></div>"; 
...
//     docFile_title +=" <div class='text' style=' text-align:right;'> 单位：万千瓦、万千瓦时、万元、元/兆瓦时、分、% </div> ";
	docFile_title +="<div class='text' style='text-align:right;'><font size='3'  face='宋体' color='black'>单位：万千瓦、万元</font></div> ";    
