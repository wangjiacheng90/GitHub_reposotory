...
function I(G, _) {
    ...
    function E(K, J) {
        ...
        function C() {
        	...
        	var A_url ="../../../assets/My97DatePicker/";  //2018-07-18 修改了路径
            ...
            var $ = ["<head><script>", 
            	...
            	"</script>" +
            	"<script src=", 
            	A_url, "lang/", _.name, ".js charset=", _.charset, "></script>"];
            if (F) $[1] = "document.domain=\"" + I + "\";";
            for (var C = 0; C < D.length; C++) if (D[C].name == J.skin) $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A_url + "skin/" + D[C].name + "/datepicker.css\" charset=\"" + D[C].charset + "\"/>");
//            $.push("<script src=\"" + A + "calendar.js\"></script>");
//            2018-07-18 修改
            $.push("<script src=\"" + A_url+ "calendar.js\"></script>");
