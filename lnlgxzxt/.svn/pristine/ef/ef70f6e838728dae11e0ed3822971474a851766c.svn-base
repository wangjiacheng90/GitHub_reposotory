...
<div class="page-content clearfix">
 ...
 <!-- 工具栏 -->
    ...
    -->
		  ...
		  <!-- 数据表格 -->
		<div class="sort_list">
    <table class="table table-striped table-bordered table-hover" width="40%" id="dataList_table" style="table-layout: fixed; width:60%; word-break:break-all; word-wrap:break-all;">
	...
	<script type="text/javascript" src="js/main/jsgl/yddl.js"></script>
     </div>
     </div>
