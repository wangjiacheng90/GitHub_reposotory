...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  location.href="/myfirstSpring/views/test/login2.jsp";
	...
	<body>
        ...
        <script type="text/javascript">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">  <!-- 导航上面的链接-->
			...
			<div class="main-container-inner">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="javascript:void(0)" name="/myfirstSpring/views/test/2.jsp" class="iframeurl" title=""><i class="icon-home"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="/myfirstSpring/views/test/Products_List.jsp"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
						 ...
						 <li class="home"><a href="javascript:void(0)" name="/myfirstSpring/views/test/Category_Manage.jsp" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
					...
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text"> 图片管理 </span><b class="arrow icon-angle-down"></b></a>
						...
						<li class="home"><a href="javascript:void(0)" name="/myfirstSpring/views/test/Sort_ads.jsp" title="分类管理"  class="iframeurl"><i class="icon-double-angle-right"></i>分类管理</a></li>
							</ul>
						</li>
					<li>
					<a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 交易管理 </span><b class="arrow icon-angle-down"></b></a>
                    <ul class="submenu">
                    <li class="home"><a href="javascript:void(0)" name="/myfirstSpring/views/test/transaction.jsp" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="/myfirstSpring/views/test/Orderform.jsp" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
           ...
           $("#menu_style").niceScroll({  
	        ...
	        cursorborderradius:"5px"  
                ...
                <script type="text/javascript">
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="/myfirstSpring/views/test/2.jsp">  </iframe>
...
<!-- /.page-content -->
		 ...
		 <script type="text/javascript">try{ace.settings.check('footerstyle' , 'fixed')}catch(e){}</script>
          <p class="l_f">版权所有：北京科东电力控制系统有限责任公司专业开发</p>
          <p class="r_f">电话：15940431285</p>
         </div>
