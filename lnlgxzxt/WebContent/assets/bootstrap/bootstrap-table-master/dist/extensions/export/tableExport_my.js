  ...
  $.fn.tableExport = function (options) {
    ...
    if ( defaults.type === 'csv' || defaults.type === 'tsv' || defaults.type === 'txt' ) {
      ...
      $(el).filter(function () {
        ...
        //zwl2018-07-17 进行了修改，可配置table属性===================
        // Header   2018-06-21 这里增加了 border 属性
        
       // docData += '<table  border="1" width="100%" class="table table-hover" ><thead>';
        docData +=export_tableStyle_config();
        // Header  zwl2018-07-17 进行了修改，可配置table属性======以上================
        ...
        $hrows.each(function () {
          ...
          if ( trData.length > 0 )
        	  //2018-07-18 增加了这里，使导出excel时 识别换行=============================================
        	  trData=trData.replace(/\n/g,"<br />") 
        	   //2018-07-18 增加了这里，使导出excel时 识别换行==================以上===================    	  
   ...
   // 2018-06-21 这增加了 格式样式==============
      docFile +=export_style_config();
 
// 2018-06-21 这以上增加了 格式样式=========================
      
      docFile += "</head>";
      docFile += "<body>";
      
      // 2018-06-21 这增加了 标题  ===============================
      docFile +=export_title_config();

   // 2018-06-21 这以上增加了 标题  ============================
      docFile += "<div class=\"Section" + ((defaults.mso.pageOrientation === 'landscape') ? "2" : "1") + "\">";
      docFile += docData;
      docFile += "</div>";
      
//      2018-07-16 这里增加了打印结尾=================================================
      docFile +=export_bottom_config();
//    2018-07-16 这里增加了打印结尾=================================================
