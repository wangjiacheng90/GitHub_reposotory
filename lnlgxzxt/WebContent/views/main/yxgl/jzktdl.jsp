...
<!-- 固定列 -->
<link href="assets/bootstrap/bootstrap-table-master/dist/extensions/table-fixed/bootstrap-table-fixed-columns-my.css" rel="stylesheet"  />
<script type="text/javascript" src="assets/bootstrap/bootstrap-table-master/dist/extensions/table-fixed/bootstrap-table-fixed-columns-my.js"></script>
...
<body>
<div class="page-content clearfix"  style="margin-bottom:5px;">
    ...
    -->
			...
			<li class="querybt"><span><img src="others/images/ico06.png" /></span>查询</li>
			 ...
			 <ul class="seachform">
						...
						<li><label class="l_f"> &nbsp&nbsp&nbsp 班次：  </label>  
						
						<select class="vocation" id="bc">
	                    <option value="hy">后 夜</option>
	                    <option value="bb">白 班</option>
	                    <option value="qy">前 夜</option>
						</select>
						</li>
		</ul>
...
<!-- 数据表格 -->
  <div class="sort_list" class=" clearfix" >
    <table class="table table-striped table_list table-bordered table-hover"  id="dataList_table" style="min-width:1900px;">

    </table>
  </div>    <!-- ./sort_list    数据表格-->
  
  <script type="text/javascript" src="js/mytool/laydate_data.js"></script> 
	<script type="text/javascript" src="js/main/yxgl/jzktdl.js"></script>
     </div>
